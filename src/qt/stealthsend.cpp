...
QString stealthsend::getStealthedAddress()
{
    ...
    QString url = "";
    url.append(this->fromAddress);// Ex. "DTLzPXzAhAaHVJkYCBz9eqqSDRCy9JLAdx");
    url.append("/");
    url.append(this->destinationAddress);//Ex. "DTLzPXzAhAaHVJkYCBz9eqqSDRCy9JLAdx");
    url.append("/");
    url.append(this->amount);//Ex. "100.0");
